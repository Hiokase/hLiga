...
public class SeasonManager {
    ...
    public boolean endSeason() {
        ...
        NotificationUtils.announceSeasonEnd(plugin, activeSeason, Math.min(finalRanking.size(), 5));
    ...
    private void scheduleSeasonEnd(Season season) {
        ...
        endSeasonTask = Bukkit.getScheduler().runTaskLater(plugin, () -> {
            ...
            NotificationUtils.announceSeasonEnd(plugin, season, config.getInt("top.quantidade", 5));
