...
public class TemporadaCommand implements CommandExecutor, TabCompleter {
    ...
    private static class DateParseResult {
        ...
        DateParseResult(LocalDate targetDate) {
            ...
            this.days = 0; // Não usado para datas específicas
        }
    }
    ...
    private boolean handleIniciar(CommandSender sender, String[] args) {
        ...
        // para determinar onde termina o nome e começa os parâmetros numéricos
        ...
        if (success) {
            ...
            if (season != null) {
                // A notificação para todos os outros jogadores já é feita pelo NotificationUtils
                ...
                // Removendo duplicação do webhook
            }
        } else {
    ...
    private boolean handleFechar(CommandSender sender) {
        ...
        // Isso impede que múltiplos comandos simultâneos fechem a mesma temporada
